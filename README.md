...
자기평가보고서 초안과 기존 학교생활기록부를 바탕으로, 희망 대학의 학생부종합전형 평가 항목과 반영 비율에 맞춘 **다음 학기 보완 활동**을 설계하는 Streamlit 앱입니다.
...
- 자기평가보고서 초안
- 기존 생기부 원문(PDF 또는 UTF-8 TXT, 최대 10MB)

지원 활동 구분은 `세부능력특기사항`, `동아리활동`, `자율자치활동`, `진로활동`, `봉사활동`입니다. 현재 등록된 모집요강은 성균관대학교 자료입니다.
...
| `ingestion/build_index.py` | 모집요강 검색 인덱스 생성·갱신 |
| `data/college_table.pdf` | 대학 모집요강 원문 |
