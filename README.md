...
지원 활동 구분은 `세부능력특기사항`, `동아리활동`, `자율자치활동`, `진로활동`, `봉사활동`입니다. 현재 성균관대학교, 동국대학교, 경희대학교 모집요강이 등록되어 있습니다.
...
먼저 대학별 모집요강 검색 인덱스를 만듭니다. `config.py`에 등록한 학생부종합 평가기준 페이지만 읽고 임베딩하므로 모집요강 전체를 처리하지 않습니다.
